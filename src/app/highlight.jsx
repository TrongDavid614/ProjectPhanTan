...
export default function Highlight() {
  ...
  useEffect(() => {
    // prevent body scroll when menuOpen
    if (menuOpen) {
    ...
    >
      ...
      >
        <nav
          ...
          onWheel={(e) => {
            // prevent wheel events from reaching the page behind
            e.stopPropagation();
          }}
        >
      ...
      <div className="relative z-10 flex flex-col items-center min-h-screen text-white text-center px-6">
        ...
        />
        <img
          src="/assets/images/anh_trai_vuot_ngan_chong_gai.png"
          alt=""
          style={{
            width: "100%",
          }}
          ...
          >
            <div>
              ...
              <img
                ...
                src="/assets/images/nhasaosang.png"
                alt=""
              />
              <span
                style={{
