...
export default function Artist() {
  ...
  const menuItems = [
    { label: "TICKETS", href: "/user/concerts", showArrow: true },
    { label: "HIGHLIGHT", href: "/highlight" },
    { label: "RETAIL", href: "#", showArrow: true },
    { label: "EXPERIENCE", href: "/" },
    { label: "ARTISTS", href: "/user/artists" },
    { label: "DROP", href: "#" },
    { label: "STORIES", href: "#" },
  ];
  ...
  return (
    ...
    >
      ...
      <button
        ...
        onMouseEnter={(e) => {
          if (!selectedArtist) e.currentTarget.style.opacity = "1";
        }}
        onMouseLeave={(e) => {
          if (!selectedArtist) e.currentTarget.style.opacity = "0.75";
        }}
      >
        <svg
          width="36"
