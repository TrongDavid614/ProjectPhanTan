...
function RadioCircle({ checked }) {
  return (
    <div className={`${styles.radio} ${checked ? styles.radioActive : ""}`}>
    ...
    <div className={styles.container}>
      <div className={styles.wrapper}>
        ...
        <div className={styles.header}>
          <div>
            <EventTitle
              title="[CONCERT] ANH TRAI VƯỢT NGÀN CHÔNG GAI DAY3, DAY4"
              compact
            />
        ...
        <div className={styles.termsSection}>
          <p className={styles.termsTitle}>
            Bạn đã đọc và hoàn toàn đồng ý "Điều khoản và điều kiện" của chương
            trình *
          </p>
        ...
        <div className={styles.promoSection}>
          <p className={styles.promoTitle}>Mã khuyến mãi</p>
        ...
        <div className={styles.paymentSection}>
          ...
          <button
            ...
            className={`${styles.paymentBtn} ${
              payment === "vnpay" ? styles.paymentActive : ""
            }`}
          >
        ...
        <div className={styles.submitWrapper}>
          <button
            ...
            className={`${styles.submitBtn} ${
              valid ? styles.submitActive : styles.submitDisabled
            }`}
          >
            Tiếp tục thanh toán
          </button>
